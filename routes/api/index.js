...
router.post('/airport', function (req, res) {
  ...
  return axios.get(`https://airport.api.aero/airport/match/${name}?user_key=${key}`)
...
router.get('/airports', function (req, res) {
  return axios.get(`https://airport.api.aero/airport?user_key=${key}`)
    .then(response => {
...
router.post('/airports/distance', function (req, res) {
  ...
  return axios.get(`https://airport.api.aero/airport/distance/${airportA}/${airportB}?user_key=${key}&units=mile`)
